...
class MySpider(CrawlSpider):
    ...
    start_urls = ["https://www.bienesraicesarletteescobar.com.mx/properties/mexico/oaxaca/oaxaca-de-juarez?page=1&web_page=properties"]
    ...
    def parse(self, response):
        ...
        item.add_xpath("property_type", 
                        "//td[text()='Tipo:']/following-sibling::td/text()",
                        MapCompose(self.spaces_fix))
        item.add_value("seller", "arlette", 
                       MapCompose(self.spaces_fix))
        item.add_xpath("address", 
                        "//h2/a[1]/text()",
                        MapCompose(self.spaces_fix))
        item.add_xpath("price", 
                        "//div[@id='prices']//span/text()",
