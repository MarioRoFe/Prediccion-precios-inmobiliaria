...
class MySpider(CrawlSpider):
    ...
    start_urls = [
        "https://www.nuroa.com.mx/venta-casas/casa-oaxaca",
    ...
    def parse(self, response):
        ...
        item.add_xpath("address", "//div[@class='location']/text()")
        item.add_xpath(
            "price",
...
process = CrawlerProcess({"FEED_FORMAT": "csv", "FEED_URI": "casas_nuroa_2.csv"})
