...
class MySpider(CrawlSpider):
    ...
    start_urls = [
        "https://casas.mitula.mx/casas/casas-oaxaca-juarez",
    ...
    rules = (Rule(LinkExtractor(allow=r"/adform/.*"), follow=True, callback="parse"),)
    ...
    def parse(self, response):
        ...
        item.add_xpath(
            "address", "//div[@class='location-map__location-address-map']/text()"
        )
        item.add_xpath(
            "price",
        ...
        for feature in features:
            ...
            if feature_name.strip() == "Tipo de vivienda:":
                ...
                item.add_value("land_area", feature_value, MapCompose(self.area_fix))

        yield item.load_item()


process = CrawlerProcess({"FEED_FORMAT": "csv", "FEED_URI": "casas_mitula.csv"})
